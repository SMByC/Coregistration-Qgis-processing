...
def get_zip_name():
    if platform.system() == "Windows":
        return 'Coregistration_Windows_{}.zip'.format(py_version)
    if platform.system() == "Darwin":
        return 'Coregistration_MacOS_{}.zip'.format(py_version)
    if platform.system() == "Linux":
        return 'Coregistration_Linux_{}.zip'.format(py_version)
